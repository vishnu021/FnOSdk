...
/**
 * Active order for multi-target index-based strategies. Mirrors {@link ActiveIndexOrder}
 * but tracks multi-target state: currentTargetIndex, targetQuantities, and target advancement.
 *
 * <p>Implements {@link MultiTargetOrder} to provide the multi-target API used by
 * DualTargetStopLossStrategy, TripleTargetStopLossStrategy, and TrailingMultiTargetStopLossStrategy.
 */
// CPD-OFF - Intentional structural similarity with ActiveIndexOrder (multi-target variant)
@Getter
public final class MultiTargetActiveIndexOrder extends AbstractActiveOrder implements MultiTargetOrder {
    ...
    public MultiTargetActiveIndexOrder(MultiTargetOrderRequest openOrder, double buyPrice, int timestampIndex,
    ...
    // --- Standard ActiveOrder methods (same as ActiveIndexOrder) ---
    ...
    public boolean equals(Object o) {
        ...
        MultiTargetActiveIndexOrder that = (MultiTargetActiveIndexOrder) o;
